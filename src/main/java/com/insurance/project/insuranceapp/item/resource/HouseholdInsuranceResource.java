...
public class HouseholdInsuranceResource {
    ...
    public HouseholdInsuranceResource(HouseholdInsurance insurance) {
    ...
    this.equipmentValue=insurance.getEquipmentValue();
    }

    public HouseholdInsurance toInsurance(long id) {
